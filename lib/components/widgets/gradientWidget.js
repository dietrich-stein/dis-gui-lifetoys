...
function GradientWidget(_ref) {
  ...
  var handleStopFieldMouseDown = function handleStopFieldMouseDown(event) {
    ...
    var updatedStops = stopsState.slice();
  ...
  var getCleanStops = function getCleanStops() {
    ...
    var cleanStops = stopsState.slice();
  ...
  return /*#__PURE__*/_react["default"].createElement(_row["default"], null, /*#__PURE__*/_react["default"].createElement(_label["default"], null, label + ' (' + stopIndexState + '/' + stopsState.length + ')'), /*#__PURE__*/_react["default"].createElement(_control["default"], null, /*#__PURE__*/_react["default"].createElement("canvas", {
    ref: canvasRef,
  ...
  }), expandedState && /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
    ref: stopfieldRef,
  ...
  //
  stops.length > 1 && stops.indexOf(stopIndexState) > -1 && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_colorRange["default"], {
    label: "Red",
