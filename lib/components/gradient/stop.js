...
var Stop = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Stop, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("svg", {
        ...
        style: {
          left: "".concat(this.props.stop * this.context.style.controlWidth - selectScale * this.context.style.computed.fontHeight / 2, "px"),
          position: 'absolute',
          cursor: 'pointer'
        }
        ...
        fill: "rgb(".concat(this.props.red, ", ").concat(this.props.green, ", ").concat(this.props.blue, ")"),
        stroke: border,
        strokeWidth: "4"
      }))));
    }
