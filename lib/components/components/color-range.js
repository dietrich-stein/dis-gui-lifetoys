...
var ColorRange = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ColorRange, _React$PureComponent);
  var _super = _createSuper(ColorRange);
  function ColorRange() {
  ...
  _createClass(ColorRange, [{
    ...
    value: function render() {
      ...
      }, this.props.label), /*#__PURE__*/_react["default"].createElement(_numberRange["default"], {
        width: "80%",
        min: 0,
        max: 255,
        step: 1,
